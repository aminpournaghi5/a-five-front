              ...
              <Typography sx={{ fontSize: { xs: "12px", md: "16px" } }}>
                {exerciseId === "" ? (
                  ...
                  <span>
                    ...
                    ادامه، تمرین جدیدی اضافه کرده و تغییرات را ذخیره کنید. در
                    صورت انصراف، روی دکمه لغو کلیک کنید.
                  </span>
                )}
              </Typography>
              <Box
              ...
              <>
                ...
                >
                  <Button
                    ...
                    color="primary"
                    onClick={
                      exerciseId === "" ? addExerciseList : UpExerciseList
                    }
                    sx={{
                      width: "45%",
                      fontFamily: fontFamilies.bold,
